...
chmod +x "/tools/plink2_linux_avx2_20250129/plink2"
echo 'export PATH="/tools/plink2_linux_avx2_20250129:$PATH"' >> ~/.bashrc
source ~/.bashrc
...
/tools/plink2_linux_avx2_20250129/plink2 --help
